...
net = cv2.dnn.readNetFromTensorflow(r'C:\Users\UseR\PycharmProjects\pythonProject\graph_opt.pb')
...
def pose_estimation(frame):
    ...
    cv2.putText(frame,'%.2gms' % (t/freq),(10,20),cv2.FONT_HERSHEY_SIMPLEX,0.5,(0,0,0))
